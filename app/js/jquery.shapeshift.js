          ...
          $container.children("." + active_class).filter(options.dragWhitelist).draggable({
            ...
            start: function(e, ui) {
              ...
              $selected = $(e.target);
			  	...
			  	//console.log("drag_clone = ", drag_clone);
              ...
              if (drag_clone) {
                //$clone = $selected.clone(false, false).insertBefore($selected).addClass(clone_class);
				  ...
				  $clone = $selected.clone(false, false);
				  $clone.find(".gauge").attr("id", newID);
				  
				  console.log($clone.find(".gauge").attr("id"));
				  
				  
				  $clone.insertBefore($selected).addClass(clone_class);
